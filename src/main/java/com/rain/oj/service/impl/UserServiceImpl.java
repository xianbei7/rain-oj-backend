...
import com.rain.oj.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public LambdaQueryWrapper<User> getQueryWrapper(UserQueryRequest userQueryRequest) {
        ...
        queryWrapper.orderBy(SqlUtils.validSortField(userQueryRequest.getSortField()), sortOrder.equals(CommonConstant.SORT_ORDER_ASC), user -> userQueryRequest.getSortField());
        return queryWrapper;
    }
}
